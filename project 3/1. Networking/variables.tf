...
variable "public_route_table_tag" {
  ...
  type        = string
  default     = "wordpress_public_route_table"
}

variable "database_route_table_tag" {
  description = "Tage for database route table"
  type        = string
  default     = "wordpress_database_route_table"
}
variable "cidr" {
...
variable "public_subnet_tag_1" {
  ...
  type        = string
  default     = "wordpress_public_subnet_az_1a"
}
variable "public_subnet_tag_2" {
  description = "Tag for public subnet"
  type        = string
  default     = "wordpress_public_subnet_az_1b"
}
...
variable "database_subnet_tag_1" {
  ...
  type        = string
  default     = "wordpress_database_subnet_az_1a"
}
variable "database_subnet_tag_2" {
  description = "Tag for Private Subnet"
  type        = string
  default     = "wordpress_database_subnet_az_1b"
}
